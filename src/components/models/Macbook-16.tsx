...
Files: .\macbook-16.glb [639.28KB] > E:\Projects\mac-demo\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props: React.JSX.IntrinsicElements['group']) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if ((child as THREE.Mesh).isMesh && !noChangeParts.includes(child.name)) {
