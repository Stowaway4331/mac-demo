  ...
  useGSAP(() => {
    if (!isTablet) {
      const timeline = gsap.timeline({
        scrollTrigger: {
          trigger: '#showcase',
          start: 'top top', // when the top of the element reaches the top of the screen
          end: 'bottom top', // when the bottom of the element reaches top of the screen
          scrub: true, // play the animation only while scrolling
          pin: true,
        }
      });
